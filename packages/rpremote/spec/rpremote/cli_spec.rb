...
RSpec.describe "Using the rpremote command-line interface" do
  let(:described_class) { Rpremote::CLI }
  let(:stdout) { StringIO.new }
  let(:stderr) { StringIO.new }

  describe "Getting help and discovering command syntax" do
  ...
  describe "Discovering connected boards" do
  ...
  describe "Inspecting effective configuration" do
  ...
  describe "Reporting invalid commands" do
  ...
  describe "Building and deploying custom firmware" do
  ...
  describe "Managing project mrbgems" do
  ...
  describe "Flashing persistent board firmware" do
  ...
  describe "Rejecting removed command syntax" do
  ...
  describe "Staging a boot application with DFU" do
  ...
  describe "Running a Ruby source file" do
  ...
  describe "Opening interactive sessions" do
  ...
  describe "Executing inline Ruby code" do
  ...
  describe "Managing the remote filesystem" do
  ...
  describe "Resetting the connected board" do
