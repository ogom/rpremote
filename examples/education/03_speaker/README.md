...
Each button press drives a piezo buzzer at 1000 Hz, about 3.05% duty cycle, for
200 ms. These settings match `03_speaker.py`: `frequency=1000`,
`duty_u16(2000)`, and 200 ms.
...
Each press makes a short beep and prints to serial output. Stopping with
`Ctrl-C` turns PWM off.
